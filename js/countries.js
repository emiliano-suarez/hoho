...
s_a[3] = "Alberta|British Columbia|Manitoba|New Brunswick|Newfoundland|Northwest Territories|Nova Scotia|Nunavut|Ontario|Prince Edward Island|Quebec|Saskatchewan|Yukon Territory";
...
s_a[131] = "Antananarivo|Antsiranana|Fianarantsoa|Mahajanga|Toamasina|Toliara";
...
function populateStates(countryElementId, stateElementId, selectedState) {
    ...
    for (var i = 0; i < state_arr.length; i++) {
        stateElement.options[stateElement.length] = new Option(state_arr[i], i);
        if (selectedState == i){
...
function populateCountries(countryElementId, stateElementId, selectedCountry, selectedState) {
    ...
    for (var i = 0; i < country_arr.length; i++) {
		  countryElement.options[countryElement.length] = new Option(country_arr[i], i);
